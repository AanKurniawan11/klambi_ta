...
import 'package:klambi_ta/Pages/payment/components/paymentCartMethode.dart';
import 'package:klambi_ta/Pages/payment/components/paymentCartShipping.dart';
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Icon(Icons.location_on,
                                  color: ColorValue.kSecondary, size: 28),
                              SizedBox(width: 10),
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                          ...
                          Align(
                            ...
                            child: TextButton(
                              ...
                              child: Text("Ganti",
                                  style:
                                      TextStyle(color: ColorValue.kSecondary)),
                            ),
                          ),
                        ],
                      ),
                      ...
                      Row(
                        children: [
                          Icon(CupertinoIcons.cart_fill,
                              color: ColorValue.kDarkGrey, size: 28),
                          SizedBox(width: 10),
                          Text(
                            "Rincian Pesanan",
                            style: TextStyle(
