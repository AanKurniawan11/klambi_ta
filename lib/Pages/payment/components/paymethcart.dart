...
class PaymethCart extends StatelessWidget {
  final CartControllers controller = Get.find(); // Mengambil instance controller
              ...
              child: DropdownButton<String>(
                ...
                onChanged: (String? newValue) {
                  if (newValue != null) {
                    ...
                    controller.addPayCart(); // Kirim data langsung setelah memilih metode pembayaran
                  }
                },
                icon: Icon(
